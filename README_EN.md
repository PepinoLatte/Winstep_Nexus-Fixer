...
| **Secondary** | **`WinstepFixer-v1.0.0-x86-Win10-Win11.zip`** | Windows 10 / Windows 11 | 32-bit (x86) | Runs natively on 32-bit Windows 10/11 and via WOW64 on 64-bit systems |
